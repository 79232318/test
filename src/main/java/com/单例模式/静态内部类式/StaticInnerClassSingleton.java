package com.单例模式.静态内部类式;

import com.单例模式.饿汉式.Singleton;
...
public class StaticInnerClassSingleton {
    ...
    public static void main(String[] args) {
    	StaticInnerClassSingleton simpleSingleton1 = StaticInnerClassSingleton.getInstance();
    	StaticInnerClassSingleton simpleSingleton2 = StaticInnerClassSingleton.getInstance();
